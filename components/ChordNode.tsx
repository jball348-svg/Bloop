...
export default function ChordNode({ id }: { id: string }) {
    ...
    return (
        <div className={`bg-slate-900 border-2 border-sky-500 rounded-2xl p-5 shadow-2xl text-white w-56 min-h-[180px] flex flex-col transition-all hover:shadow-sky-500/20 group relative${
